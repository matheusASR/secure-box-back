...
export class InitialMigration1711211853091 implements MigrationInterface {
    name = 'InitialMigration1711211853091'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "email" character varying(45) NOT NULL, "name" character varying(100) NOT NULL, "password" character varying(120) NOT NULL, "cpf" character varying(11) NOT NULL, "cel" character varying(11) NOT NULL, "birthdate" character varying(10) NOT NULL, "address" jsonb NOT NULL, "admin" boolean NOT NULL DEFAULT false, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_230b925048540454c8b4c481e1c" UNIQUE ("cpf"), CONSTRAINT "UQ_fef935dafbb0415c8bfc37c8a61" UNIQUE ("cel"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "allocations" ("id" SERIAL NOT NULL, "initialDatetime" character varying(50) NOT NULL, "finalDatetime" character varying(50) NOT NULL, "price" character varying(10) NOT NULL, "paymentStatus" boolean NOT NULL, "finished" boolean NOT NULL, "pressed" boolean NOT NULL, "unlocked" boolean NOT NULL, CONSTRAINT "PK_ca63099fc248466264af0fa6f1f" PRIMARY KEY ("id"))`);
