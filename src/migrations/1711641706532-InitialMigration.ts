...
export class InitialMigration1711641706532 implements MigrationInterface {
    name = 'InitialMigration1711641706532'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "adresses" ("id" SERIAL NOT NULL, "street" character varying(100) NOT NULL, "number" character varying(50) NOT NULL, "city" character varying(100) NOT NULL, "state" character varying(100) NOT NULL, "zipCode" character varying(20) NOT NULL, "complement" character varying(255), CONSTRAINT "PK_2787c84f7433e390ff8961d552d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "wallets" ("id" SERIAL NOT NULL, "balance" numeric NOT NULL, CONSTRAINT "PK_8402e5df5a30a229380e83e4f7e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "allocations" ("id" SERIAL NOT NULL, "initialDatetime" character varying(50) NOT NULL, "finalDatetime" character varying(50) NOT NULL, "price" character varying(10) NOT NULL, "paymentStatus" boolean NOT NULL DEFAULT false, "finished" boolean NOT NULL DEFAULT false, "userId" integer, "cageId" integer, CONSTRAINT "PK_ca63099fc248466264af0fa6f1f" PRIMARY KEY ("id"))`);
